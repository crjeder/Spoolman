...
- [ ] NFC / QR sticker integration — [OpenSpoolMan](https://github.com/drndos/openspoolman) or [OpenTag3D](https://opentag3d.info/) compatible; spool NFC URL already maps to `/api/v1/spool/<id>`
